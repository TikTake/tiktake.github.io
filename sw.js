// sw.js
const CACHE_NAME = "tiktake-cache-dynamic";
const urlsToCache = ["/index.html", "/js/home.min.js", "/icons/128.png", "/icons/256.png", "/icons/512.png", "/manifest.json"];
  ...
  event.waitUntil(
    (async () => {
      try {
        ...
        await Promise.all(successfulResponses.map(({ url, response }) => cache.put(url, response)));
